...
public class TaskAdapter extends ArrayAdapter<Task> {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.taskCompletedCount = (TextView) view.findViewById(R.id.tvTaskCompletedCount);
        ...
        if(holder.taskCompletedCount!=null && task.getTotal()!=null && task.getCompleted()!=null)
            holder.taskCompletedCount.setText("(" + task.getCompleted() + "/" + task.getTotal() + ")");
	...
	public class ViewHolder {
        ...
        public TextView taskCompletedCount;
	}
