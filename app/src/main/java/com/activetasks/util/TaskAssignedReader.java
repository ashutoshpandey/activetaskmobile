 ...
 */
public class TaskAssignedReader extends AsyncTask<String, Integer, String> {

    private JsonReaderSupport jsonReaderSource;
    private String url;

    public TaskAssignedReader(JsonReaderSupport jsonReaderSource, String url){
    ...
    protected String doInBackground(String... params) {
        ...
        data.add(new BasicNameValuePair("task_id", taskId));
